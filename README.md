...
Following example shows Node dependencies view in Event Viewer View container.

![Event Viewer](./resources/event-explorer.png)
...
- Node dependencies view is shown in Event Viewer view container in Activity bar.
